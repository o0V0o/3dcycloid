...
local a, stepsize = 0, 0.5
local function gear2d3d()
	print("click")
	local n = 50
	local cycloid = require("cycloid")(6)
	...
	for j=1,4 do
		...
		local axis =  vec3(x,y,0):normalize()
		for i=1,n do
			cycloid:rotate(axis, 2*math.pi/n)
...
require("eventhandler")("next", "click", gear2d3d)
